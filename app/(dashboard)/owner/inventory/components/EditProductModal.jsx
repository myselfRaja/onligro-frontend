...
export default function EditProductModal({ isOpen, onClose, onSuccess, productData }) {
  ...
  useEffect(() => {
    if (productData) {
      setForm({
        ...
        mrp: productData.mrp || "",
        salonMargin: productData.salonMargin || "",
        salonLandingPrice: productData.salonLandingPrice || "",
        distributorMargin: productData.distributorMargin || "",
        distributorLandingPrice: productData.distributorLandingPrice || "",
        ssPrice: productData.ssPrice || "",
        clp: productData.clp || "",
        gst: productData.gst || "",
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/products/update/${productData._id}`, {
        method: "PUT",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        {/* Form - Same as AddProductModal but with pre-filled values */}
